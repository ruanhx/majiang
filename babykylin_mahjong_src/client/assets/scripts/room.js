...
cc.Class({
    ...
    onLoad: function () {
        ...
        this.roomIdLabel = this.node.getChildByName('roomIdLabel');
    ...
    initPomelo: function () {
        ...
        pomelo.on('room.removeMember',function(data){
            var mySelf = self.memberList[data.memberId];
            delete self.memberList[data.memberId];
            mySelf.destroy();
        });
    ...
    initRoomInfo: function () {
        ...
        pomelo.request('area.roomHandler.getRoomInfo', { id: cc.vv.userMgr.roomData }, function (res) {
            ...
            self.roomIdLabel.getComponent(cc.Label).string = "房间号：" + res.info.id;
    ...
    onExitButton: function () {
        var self = this;
        pomelo.request('area.roomHandler.exitRoom', { id: cc.vv.userMgr.roomData }, function (res) {
            cc.log("area.roomHandler.exitRoom: %j", res);

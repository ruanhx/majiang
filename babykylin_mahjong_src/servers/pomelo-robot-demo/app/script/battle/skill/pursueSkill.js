...
var Skill = require('./skill'),
    ...
    Pursue = require('../buffer/pursue'),
    utils = require('../../utils/utils');

var PursueSkill = function(opts){
    Skill.call(this, opts);
};

util.inherits(PursueSkill, Skill);

var pro = PursueSkill.prototype;
...
pro.useAtTarget = function(act, user, target, tick){
    ...
    // 处理技能效果
    buf = new Pursue(target, user, this, tick);

...
var Skill = require('./skill'),
    ...
    MultiCut = require('../buffer/multiCut'),
    utils = require('../../utils/utils');

var MultiCutSkill = function(opts){
    Skill.call(this, opts);
};

util.inherits(MultiCutSkill, Skill);

var pro = MultiCutSkill.prototype;
...
pro.useAtTarget = function(act, user, target, tick){
    ...
    // 处理技能效果
    buf = new MultiCut(target, user, this, tick);

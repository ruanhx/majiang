...
async.series([
    ...
    app.post('/order_taiqi_hudong_android', order.order_taiqi_hudong_android);                     // 泰奇-互动
    app.post('/order_taiqi_inland_android', order.order_taiqi_inland_android);              // 泰奇-互动-国内

    // =================================================================================================================//

    app.post('/SCADA', SCADA.pushLog);

    http.createServer(app).listen(app.get('port'), function () {
        console.log('Express server listening on port ' + app.get('port'));
    });
    rechargeReward.getInstance().initData();
    app.post('/gainAward', userInfo.gainAward);

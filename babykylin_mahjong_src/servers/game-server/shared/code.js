module.exports = {
    ...
    AREA: {
        ...
        //没有足够挑战次数
        ACTIVITY_CUSTOM_CNT_NOT_ENOUGH:3216,
        //挑战冷却中
        ACTIVITY_CUSTOM_COOLING:3217,
        //没有足够扫荡券
        SWEEP_TICKET_NOT_ENOUGH:3218,
        //还没通过前置关卡
        INVALID_ACTIVITY_CUSTOM:3219,
        //还没通过前置关卡
        INVALID_CATCH_TREATURE_CUSTOM:3220,
        //状态错误
        CATCH_TREATURE_STATUS_ERR :3221,
        //验证错误
        CATCH_TREATURE_CHECK_ERR :3222,
        //抓取次数不够
        CATCH_TREATURE_COUNT_NO :3223,
        //购买次数不够
        CATCH_TREATURE_BUY_COUNT_NO :3223,
        // 三星券使用错误
        THREE_STAR_ITEM_ERROR :3224,
        //购买次数不足
        BUY_COUNT_NO : 3225,
        // 无尽模式数据异常
        ENDLESS_SCORE_INVALID: 3226,
        // 普通关卡数据异常
        BARRIER_DATA_INVALID: 3227,
        // 活动关卡数据异常
        ACTIVITY_ECTYPE_DATA_INVALID: 3228,
        // 强加等级已满
        STRENGTHEN_MAX: 3229,
        // 无尽时间限制
        ENDLESS_TIME_LIMIT: 3230,
        //金币兑换次数不足
        GOLD_BOX_CNT_LIMIT:3231,
    },
    HERO: {
        // 添加猎魔人失败
    ...
    WORLD: {
        ...
        // 排行榜类型错误
        RANKLIST_ERROR_TYPE:6008,
        // 好友上限
        FRIEND_MAX:6009,
        //删除好友次数不足
        FRIEND_REMOVE_LACK_CNT:6010,
        //好友已经存在
        FRIEND_EXIT:6011,
        //玩家miniData 不存在
        PLAYER_MINIDATA_NOT_EXIST:6012,
        // 无尽已经匹配到对手
        ENDLESS_ALREADY_MATCH:6013,
        // 无尽无法匹配到对手
        ENDLESS_CANT_MATCH:6014,
        // 无尽战斗力不匹配
        ENDLESS_POWER_NOT_MATCH:6015,
        // 无尽乱斗使用的道具不存在
        ENDLESS_USEITEM_NOT_EXIST:6016,
        //玩家不存在
        NO_PLAYER:6017,
    },
    MISSION:{
    ...
    RANDBOSS:{
        ...
        DAILY_COUNT_LIMIT:7206,//每日次数不足,
        CANT_SHARE:7207,//攻打次数不足无法分享,
        HAS_SHARE:7208,//已经分享过了无法分享
        RANBOSS_DATA_INVALID:7209,//随机boss数据异常
        // 随机boss已经被别人击杀
        HAS_KILLED:7210,
    },
    /**随机商店*/
    ...
    CHAT: {
        INVALID_CHANNEL: 8001,                  // 未知频道
        PLAYER_OFFLINE: 8002,                   // 玩家不在线
        LACK_LEVEL: 8003,                       // 等级不足
        PLAYER_NAME_BLANK: 8004,                // 名字为空
        NOT_TALK_TO_YOURSELF: 8005,             // 不可自言自语
        NO_BLANK_CONTENT: 8006,                 // 消息内容不可为空
        IN_CHAT_CD: 8007,                       // 处于聊天CD中
        CONTENT_TOO_LONG: 8008,                 // 内容太长
        YOU_BLOCKED: 8009,                      // 被屏蔽
        NO_CHAT: 8010,                          // 被禁言
        FUNC_NOT_AVAILABLE: 8011,                // 功能未开放
        CHAT_FREQUENTLY: 8012,                       // 发言过多
    },
};
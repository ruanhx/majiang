...
var EndlessRank = function (manager, player, actData) {
    ConditionAward.call(this, manager, player, actData);
    player.on('onActEndlessRankChange', this.rankChange.bind(this));
};

util.inherits(EndlessRank, ConditionAward);

var pro = EndlessRank.prototype;

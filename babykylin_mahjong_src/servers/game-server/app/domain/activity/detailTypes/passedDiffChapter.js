...
var PassedDiffChapter = function (manager, player, actData) {
    ConditionAward.call(this, manager, player, actData);
    player.on('onActPassedDiffChapter', this.onPassedChapter.bind(this));
};

util.inherits(PassedDiffChapter, ConditionAward);

var pro = PassedDiffChapter.prototype;
...
module.exports = PassedDiffChapter;
...
var endlessScoreRank = function (manager, player, actData) {
    Activity.call(this, manager, player, actData);
};

util.inherits(endlessScoreRank, Activity);

var pro = endlessScoreRank.prototype;


pro.onClose = function () {
    var self = this;
    pomelo.app.rpc.world.rankListRemote.sendEndlessScoreRankAward("*", {}, function () {
...
module.exports = endlessScoreRank;
...
playerSync.updatePlayer = function (client, player, cb) {
    var sql = 'UPDATE player SET roleLevel =?,exp=?,VIPLevel=?,diamondCnt=?,goldCnt=?,totalRechargeNum=?,' +
            ...
            'endlessSingleHighBarr = ?,freeSnatchSingeEndTick = ? ,' +
            'dailyActGoldChallenge = ?, dailyActExpChallenge = ?, dailyActItemChallenge = ?, lastCleanActivityEctype = ?  ,catchHighScore = ? ,catchKey = ?  ,lastCleanCatchTreasure=? ,heroCore=? ,catchHighScoreHistotry=? ,miniGameJoinCnt=?,  '+
            'logonDayCnt=?,logonDayCntTime=?,playername=?,headPicId=?,lastWeekHighScore=?,lastWeekHighScoreResetTick=?,moneyChangeCnt=?,playerResetTick=?'+
            ' where id=?',
        args = [
            ...
            player.endlessSingleHighBarr,player.freeSnatchSingeEndTick,
            player.dailyActGoldChallenge,player.dailyActExpChallenge,player.dailyActItemChallenge,player.lastCleanActivityEctype,player.catchHighScore,player.catchKey,player.lastCleanCatchTreasure,player.heroCore,player.catchHighScoreHistotry,JSON.stringify(player.miniGameJoinCnt),
            player.logonDayCnt,player.logonDayCntTime,player.playername,player.headPicId,player.lastWeekHighScore,player.lastWeekHighScoreResetTick,player.moneyChangeCnt,player.playerResetTick,
            player.id
        ];

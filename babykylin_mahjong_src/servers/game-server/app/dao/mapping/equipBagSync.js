...
function upsert(client, equipData, cb) {
    var sql = 'INSERT INTO EquipBag(playerId,pos,equipId,lv,quality,isNew) VALUES(?,?,?,?,?,?) ON DUPLICATE KEY UPDATE' +
            ' equipId = VALUES(equipId), lv = VALUES(lv) , isNew = VALUES(isNew)',
        args = [equipData.playerId, equipData.pos, equipData.dataId, equipData.lv,equipData.quality,equipData.isNew];

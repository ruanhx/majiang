 ...
 * */
    dao.saveGuideAchievementPercent = function (cols, cb) {
        var sql = 'INSERT INTO GuideAchievementPercent(date,guideId1,guideId2,guideId3,guideId4,guideId5,guideId6,guideId7,' +
            ...
            'guideId41,guideId42,guideId43,guideId44,guideId45,guideId46,guideId47,guideId48,guideId49,guideId50,'+
            'guideId51,guideId52,guideId53,guideId54,guideId55,guideId56,guideId57,guideId58,guideId59,guideId60,'+
            'guideId61,guideId62,guideId63,guideId64,guideId65,guideId66,guideId67,guideId68,guideId69,guideId70,'+
            'guideId71,guideId72,guideId73,guideId74,guideId75,guideId76,guideId77,guideId78,guideId79,guideId80,'+
            'guideId81,guideId82,guideId83,guideId84,guideId85,guideId86,guideId87,guideId88,guideId89,guideId90,'+
            'guideId91,guideId92,guideId93,guideId94,guideId95,guideId96,guideId97,guideId98,guideId99,guideId100,' +
            'guideId101,guideId102,guideId103,guideId104,guideId105,guideId106,guideId107,guideId108,guideId109,guideId110,'+
            'guideId111,guideId112,guideId113,guideId114,guideId115,guideId116,guideId117,guideId118,guideId119,guideId120,'+
            'guideId121,guideId122,guideId123,guideId124,guideId125,guideId126,guideId127,guideId128,guideId129,guideId130,'+
            'guideId131,guideId132,guideId133,guideId134,guideId135,guideId136,guideId137,guideId138,guideId139,guideId140,'+
            'guideId141,guideId142,guideId143,guideId144,guideId145,guideId146,guideId147,guideId148,guideId149,guideId150,'+
            'guideId151,guideId152,guideId153,guideId154,guideId155,guideId156,guideId157,guideId158,guideId159,guideId160,'+
            'guideId161,guideId162,guideId163,guideId164,guideId165,guideId166,guideId167,guideId168,guideId169,guideId170,'+
            'guideId171,guideId172,guideId173,guideId174,guideId175,guideId176,guideId177,guideId178,guideId179,guideId180,'+
            'guideId181,guideId182,guideId183,guideId184,guideId185,guideId186,guideId187,guideId188,guideId189,guideId190,'+
            'guideId191,guideId192,guideId193,guideId194,guideId195,guideId196,guideId197,guideId198,guideId199,guideId200'+
            ') VALUES(?,' +
            '?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?'+
            ',?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?' +
            ',?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?' +
    ...
    // 自动补足列数
    if (cols.length < 201) {
        cols = cols.concat(_.times(201 - cols.length, function () {
            return 0;
        }));
    }
    // 自动删除多余的列数
    if (cols.length > 201) {
        cols = cols.slice(0, 201);
    }
    pomelo.app.get('statClient').query(sql, cols, function (err, res) {
        if (err) {
...
{
    var sql = 'INSERT INTO DailyUseDiamondSTTE(playerId,date,playerName,useWay,useDiamond,surplusDiamond,time,shopGoodsId) VALUES(?,?,?,?,?,?,?,?)'+
        ' ON DUPLICATE KEY UPDATE useWay=VALUES(useWay),useDiamond=VALUES(useDiamond),surplusDiamond=VALUES(surplusDiamond),shopGoodsId=VALUES(shopGoodsId)';
    var args = [args.playerId,args.date,args.playerName,args.useWay,args.useDiamond,args.surplusDiamond,args.time,args.shopGoodsId];
    pomelo.app.get('statClient').query(sql, args, function (err, res) {
        if (err) {
